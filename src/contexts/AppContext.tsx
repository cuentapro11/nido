...
const DEFAULT_CHILDREN: Child[] = [
  {id:0,name:'Sofía',emoji:'👶',bg:'#EFF6FF',tc:'#1E3A8A',group:'Bebés',age:'14 meses',present:true,lastMin:-70,photo:null,
   ...
   tl:[
     {icon:'🚪',bg:'#EFF6FF',title:'Entrada',desc:'',time:'8:00 AM',type:'entry'},
     {icon:'📸',bg:'#EFF6FF',title:'Foto del día',desc:'Jugando con los bloques de colores.',time:'9:15 AM',type:'foto',hasImg:true,photo:null},
     {icon:'🍼',bg:'#F0F9FF',title:'Desayuno',desc:'4 oz de leche, una galleta.',time:'8:45 AM',type:'comida'},
     {icon:'😴',bg:'#EFF6FF',title:'Siesta',desc:'Durmió 45 minutos tranquila.',time:'10:00 AM',type:'sueño',duracion:'45 min'},
   ]},
  {id:1,name:'Mateo',emoji:'🧒',bg:'#EFF6FF',tc:'#185FA5',group:'Caminadores',age:'2 años',present:true,lastMin:-12,photo:null,
   ...
   fechaIngreso:'10 febrero 2025',historialPagos:['Febrero 2025 - RD$900'],notasPrivadas:'',tl:[
     {icon:'🚪',bg:'#EFF6FF',title:'Entrada',desc:'',time:'8:05 AM',type:'entry'},
     {icon:'🍼',bg:'#F0F9FF',title:'Desayuno',desc:'Comió bien, le gustaron los huevos.',time:'8:50 AM',type:'comida'},
   ]},
  {id:2,name:'Luna',emoji:'👼',bg:'#EFF6FF',tc:'#2563EB',group:'Bebés',age:'8 meses',present:false,lastMin:null,photo:null,
  ...
  {id:3,name:'Diego',emoji:'🐣',bg:'#EFF6FF',tc:'#1E3A8A',group:'Caminadores',age:'18 meses',present:true,lastMin:-92,photo:null,
   ...
   tl:[
     {icon:'🚪',bg:'#EFF6FF',title:'Entrada',desc:'',time:'7:55 AM',type:'entry'},
     {icon:'💊',bg:'#FEF3F2',title:'Medicamento',desc:'Amoxicilina 5ml administrada.',time:'10:00 AM',type:'salud'},
   ]},
];

const DEFAULT_PARENTS: Parent[] = [
  {id:0,name:'María Pérez',hijo:'Sofía',initials:'MP',bg:'#EFF6FF',tc:'#1E3A8A',msg:'Gracias por la foto 💕',time:'9:20',unread:1},
  {id:1,name:'Juan González',hijo:'Mateo',initials:'JG',bg:'#EFF6FF',tc:'#2563EB',msg:'¿Cómo va hoy?',time:'8:30',unread:0},
  {id:2,name:'Ana Torres',hijo:'Diego',initials:'AT',bg:'#EFF6FF',tc:'#1E3A8A',msg:'Le di la medicina antes de salir.',time:'7:50',unread:0},
];
...
const DEFAULT_SOLICITUDES: Solicitud[] = [
  {name:'Roberto Medina',hijo:'Valentina (2 años)',code:'RS-2891',initials:'RM',bg:'#EFF6FF',tc:'#185FA5'},
];
...
const DEFAULT_AULAS: Aula[] = [
  {id:1,nombre:'Bebés',color:'hsl(0,70%,55%)',emoji:'🍼'},
  {id:2,nombre:'Caminadores',color:'#2563EB',emoji:'👟'},
  {id:3,nombre:'Pre-escolar',color:'hsl(240,60%,62%)',emoji:'🎒'},
];
...
export const LOG_OPTS = [
  {icon:'🚪',label:'Entrada',bg:'#EFF6FF',type:'entry'},
  {icon:'🔴',label:'Salida', bg:'#EFF6FF',type:'exit'},
  {icon:'🍼',label:'Comida', bg:'#F0F9FF',type:'comida'},
  {icon:'😴',label:'Siesta', bg:'#EFF6FF',type:'sueño'},
  {icon:'📸',label:'Foto',   bg:'#EFF6FF',type:'foto'},
  {icon:'📝',label:'Nota',   bg:'#F0F9FF',type:'nota'},
  {icon:'🎨',label:'Actividad',bg:'#EFF6FF',type:'actividad'},
  {icon:'💊',label:'Salud',  bg:'#FEF3F2',type:'salud'},
  {icon:'🎬',label:'Video',  bg:'#EFF6FF',type:'video'},
  {icon:'📢',label:'Aviso',  bg:'#EFF6FF',type:'aviso'},
];
...
export function AppProvider({ children: reactChildren }: { children: React.ReactNode }) {
  ...
  const togglePresence = useCallback((childId: number) => {
    setChildren(prev => prev.map(c => {
      ...
      const newTl = [{icon: newPresent ? '🚪' : '🔴', bg: newPresent ? '#EFF6FF' : '#EFF6FF',
