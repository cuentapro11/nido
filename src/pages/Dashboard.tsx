...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      {/* Header with bell */}
      <div className="flex items-start justify-between px-4 pt-8 pb-5">
        <div>
          <h1 className="text-2xl font-extrabold text-foreground leading-tight">Cuido Rayito de Sol ☀️</h1>
          <p className="text-xs font-semibold text-muted-foreground mt-0.5">Inicio</p>
        </div>
        <button onClick={() => setShowNotifs(true)}
          className="relative w-10 h-10 bg-card border border-border rounded-2xl flex items-center justify-center shadow-card active:scale-90 transition-transform mt-0.5">
      ...
      <div className="px-4 pb-2 flex items-center justify-between">
        <span className="text-base font-extrabold text-foreground">Entradas de hoy</span>
