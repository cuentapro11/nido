...
function NotifPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="bg-gradient-to-r from-[hsl(var(--primary))] to-[hsl(var(--accent))] px-5 pt-12 pb-4 flex items-center justify-between">
        <div>
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="flex items-center justify-between px-4 pt-12 pb-3">
        <div>
          <p className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">Cuido Rayito de Sol ☀️</p>
          <h1 className="text-xl font-extrabold text-foreground">Panel</h1>
        </div>
        <button onClick={() => setShowNotifs(true)}
          className="relative w-10 h-10 bg-card border border-border rounded-2xl flex items-center justify-center shadow-card active:scale-90 transition-transform">
