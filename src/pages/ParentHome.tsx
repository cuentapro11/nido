    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="flex items-center justify-between px-4 pt-8 pb-3 border-b border-border bg-card">
        ...
        <div className="flex items-center gap-2">
          <span className={`w-2.5 h-2.5 rounded-full flex-shrink-0 ${child.present ? 'bg-[hsl(152,55%,42%)]' : 'bg-destructive'}`} />
              ...
              {item.hasImg ? (
                ...
                <div className="flex items-stretch">
                  ...
                  <button
                    ...
                    style={{ background: `linear-gradient(135deg, ${child.bg}, #fff)` }}
                  >
                    {item.photo ? (
      ...
      <BottomSheet open={showInfo} onClose={() => setShowInfo(false)}>
        <div className="flex items-center gap-3 mb-5">
          <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 bg-gradient-to-br from-[hsl(35,80%,55%)] to-[hsl(28,85%,48%)]">
