...
const ADMIN_TABS = [
  { path: '/dashboard',     icon: Home,            label: 'Inicio',       color: '#1E3A8A' },
  { path: '/children',      icon: Users,           label: 'Niños',        color: '#2563EB' },
  { path: '/chat',          icon: MessageSquare,   label: 'Chat',         color: '#1E3A8A' },
  { path: '/calendar',      icon: CalendarDays,    label: 'Calendario',   color: '#2563EB' },
  { path: '/configuracion', icon: MoreHorizontal,  label: 'Más',          color: '#1E3A8A' },
];

const PARENT_TABS = [
  { path: '/parent-home',    icon: Home,            label: 'Inicio',   color: '#1E3A8A' },
  { path: '/parent-gallery', icon: Image,           label: 'Galería',  color: '#2563EB' },
  { path: '/parent-chat',    icon: MessageSquare,   label: 'Chat',     color: '#1E3A8A' },
  { path: '/parent-profile', icon: User,            label: 'Perfil',   color: '#2563EB' },
];
